...
interface OrderCreatedEmailProps {
  ...
  /** Brand accent as `#rrggbb` (from Design panel). Drives stripe, title, highlights, and links. */
  accentColor?: string;
  /** Border radius preset from Design panel (`sharp` | `medium` | `large`). */
  radius?: string;
  /** Design panel: show “Expected delivery” block (default true). */
  showDelivery?: boolean;
  /** Design panel: show Help Center sign-off (default true). */
  showSignOff?: boolean;
}
    ...
    <Html dir="ltr" lang="en">
      ...
      <Tailwind>
        <Body className="bg-[#f4f4f5] m-0 p-0 font-sans text-[14px] text-[#3f3f46]">
          <Preview>
            {companyName}: we&apos;ve received your order #{orderNumber} and
