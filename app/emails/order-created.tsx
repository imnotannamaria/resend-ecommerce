...
export function OrderCreatedEmail({
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>
        We've received your order #{order_id} and will keep you updated.
      </Preview>
      <Body
        style={{
            ...
            <Section style={{ marginBottom: '20px' }}>
              <Row>
                <Column style={{ textAlign: 'center' }}>
                  ...
                  >
                    <Img
                      src="https://resend-ecommerce.vercel.app/shopping-cart.png"
                      alt="Shopping cart"
                      width={20}
                      height={20}
                      style={{
          ...
          <Section style={{ padding: '40px 48px' }}>
            ...
            {show_delivery && (
              ...
              >
                ...
                <Text
                  style={{ color: '#27272a', fontWeight: '500', margin: 0 }}
                >
