        ...
        <Body className="bg-[#f4f4f5] m-0 p-0 font-sans text-[14px] text-[#3f3f46]">
          ...
          >
            ...
            <Section className="px-[48px] py-[40px]">
              ...
              {showReview ? (
                <Section
                  className="text-center bg-[#fafafa] px-[20px] py-[24px] mb-[32px]"
                  style={{
                    border: '1px solid #f4f4f5',
                ...
                >
                  <Text
                    className="text-[15px] leading-[24px] font-semibold mt-0 mb-[4px]"
                    style={{ color: accent }}
                  >
                  ...
                  <Button
                    href={reviewUrl}
                    className="text-white text-[13px] font-medium px-[20px] py-[10px]"
                    style={{
                      backgroundColor: accent,
                      borderColor: accent,
                      borderRadius: emailBorderRadius(r, 'inner'),
